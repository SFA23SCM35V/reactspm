      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        {loading ? (
          ...
          <div>
            ...
            {flag && <LineCharts
              title={`Issues of ${repository.value} in last 2 months`}
            ...
            {/* Render barchart component for a monthly created issues for a selected repositories*/}
            {flag && <BarCharts
              title={`weekly Closed Issues for ${repository.value} in last 2 months`}
              data={githubRepoData?.closed_weekly}
            />}
            {/* Render stackbar component for created and closed issues*/}
            {flag && <StackBar
              title={`Created and Closed Issues of ${repository.value} in last 2 months`}
              data={githubRepoData?.created}
